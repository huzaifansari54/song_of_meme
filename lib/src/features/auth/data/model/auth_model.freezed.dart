...
abstract class $AuthModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({String id, String name, String email, String profile_url});
}
...
class _$AuthModelImpl extends _AuthModel {
  ...
  @override
  String toString() {
    return 'AuthModel(id: $id, name: $name, email: $email, profile_url: $profile_url)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, name, email, profile_url);
...
abstract class _AuthModel extends AuthModel {
  const factory _AuthModel(
      ...
      required final String profile_url}) = _$AuthModelImpl;
